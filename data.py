# This file was used when the input is single channel image and the method is transfer learning
...
def testGenerator(test_path,num_image = 6,target_size = (512,512,3),flag_multi_class = False,as_gray = True):
